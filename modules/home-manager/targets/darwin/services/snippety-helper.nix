...
let
  ...
  installerScript = pkgs.writeShellScript "snippety-helper-installer"
    # bash
    ''
      COMMAND_TIMEOUT=60
...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    home.activation.snippetyHelperInstallation = lib.hm.dag.entryAfter [ "writeBoundary" ]
      # bash
      ''
    ...
    home.activation.checkBashPermissions = lib.hm.dag.entryAfter [ "snippetyHelperInstallation" ]
      # bash
      ''
        YELLOW='\033[0;33m'
        NC='\033[0m' # No Color
    ...
    home.activation.checkXargsPermissions = lib.hm.dag.entryAfter [ "checkBashPermissions" ]
      # bash
      ''
        YELLOW='\033[0;33m'
        NC='\033[0m' # No Color
